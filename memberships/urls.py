...
from .views import (
    ...
    SimulatedPSEPaymentView,
    SimulatedCardPaymentView,
    PaymentSuccessView,
    MemberListView,
    MemberCreateView,
    MemberUpdateView,
...
urlpatterns = [
    ...
    path("payment/pse/", SimulatedPSEPaymentView.as_view(), name="simulated_pse_payment"),
    path("payment/card/", SimulatedCardPaymentView.as_view(), name="simulated_card_payment"),
